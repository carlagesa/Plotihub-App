...
from property_management_app import views, AdminViews, StaffViews
...
urlpatterns = [
    ...
    path('add_caretaker', AdminViews.add_caretaker,name="add_caretaker"),
    path('add_caretaker_save', AdminViews.add_caretaker_save,name="add_caretaker_save"),
    ...
    path('edit_caretaker/<str:caretaker_id>', AdminViews.edit_caretaker,name="edit_caretaker"),
    path('edit_caretaker_save', AdminViews.edit_caretaker_save,name="edit_caretaker_save"),
    path('edit_property/<str:property_id>', AdminViews.edit_property,name="edit_property"),
    path('edit_property_save', AdminViews.edit_property_save,name="edit_property_save"),
    ...
    # path('join_class_room/<int:caretaker_id>/<int:session_year_id>',tenantViews.join_class_room,name="join_class_room"),
